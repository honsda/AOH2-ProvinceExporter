...
document.getElementById('mapeditorfile').addEventListener('change',function () {
            ...
            fr.onload = function () {document.getElementById('showfile').innerHTML = `<p style="font-weight:bolder;background-color:rgba(49, 49, 53, 0.5);padding:10px;">${fname}</p>${this.result};`};
